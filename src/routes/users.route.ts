...
router.get('/:id', (req: Request, res: Response, next: NextFunction) => userController.findById(req, res, next));
router.get('/', (req: Request, res: Response, next: NextFunction) => userController.findAll(req, res, next));
